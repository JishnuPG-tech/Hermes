...
async def get_session_share(
    ...
    return await _proxy_to_hermes(f"sessions-share/{share_id}", request)
...
async def create_cloud_environment(
    ...
    return await _proxy_to_hermes(f"environment_providers/private/organizations/{org_id}/cloud/create", request)
...
async def git_proxy_compare(
    ...
    return await _proxy_to_hermes(f"session_ingress/session/{session_id}/git_proxy/compare", request)
...
async def get_trigger(
    ...
    """Get trigger details"""
    return await _proxy_to_hermes(f"triggers/{trigger_id}", request)
...
async def prepare_file_upload(
    ...
    """Prepare file upload"""
    return await _proxy_to_hermes(f"organizations/{org_id}/conversations/{conv_id}/files/prepare-upload", request)
...
async def submit_chat_feedback(
    ...
    return await _proxy_to_hermes(f"organizations/{org}/chat_conversations/{chat}/chat_messages/{message}/chat_feedback", request)
